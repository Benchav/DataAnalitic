...
{
    /// <summary>
    /// KPI 3 - H5: Identificar áreas temáticas con baja cobertura documental.
    /// Variables: categoria vs cantidad_recursos
    /// </summary>
    public class AnaliticCoberturaTematicaOperation
    {
        ...
        public static async Task<object?> GetByPeriodo(DataAnaliticRequest request)
        {
            ...
            var config = new HipotesisTestConfig<V_Analisis_Biblioteca>()
                .ConVariableIndependiente("Categoria")
                .ConVariableDependiente("Cantidad_Recursos")
                .AgruparPor("Categoria", "Grupo_Tematico")
            ...
            var result = DataGroupingHelper.GroupData(
                ...
                title: "Cobertura Temática por Categoría",
