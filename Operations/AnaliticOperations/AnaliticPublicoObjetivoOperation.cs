...
{
    /// <summary>
    /// KPI 4 - H6: Los recursos dirigidos a docentes presentan menor disponibilidad
    /// que los orientados a estudiantes.
    /// Variables: publico_objetivo vs cantidad_recursos
    /// </summary>
    public class AnaliticPublicoObjetivoOperation
    {
        ...
        public static async Task<object?> GetByPeriodo(DataAnaliticRequest request)
        {
            ...
            var config = new HipotesisTestConfig<V_Analisis_Biblioteca>()
                .ConVariableIndependiente("Publico_Objetivo")
                .ConVariableDependiente("Cantidad_Recursos")
                .AgruparPor("Publico_Objetivo", "Anio")
            ...
            var result = DataGroupingHelper.GroupData(
                ...
                title: "Disponibilidad por Público Objetivo",
